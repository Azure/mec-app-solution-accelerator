    ...
    while l_frame is not None:
        ...
        while l_obj is not None:
            ...
            obj_dict = {
                ...
                "class_label": labels[obj_meta.class_id-1],
...
def main(args):
    ...
    pgie.set_property('config-file-path', "configs/config_infer_primary_onnx_yolo_automl.txt")

...
{
    public class AnalyzeChairAlertCommandHandler : IRequestHandler<AnalyzeChairDetection>
    {
        private readonly DaprClient _daprClient;

        public AnalyzeChairAlertCommandHandler(DaprClient daprClient)
        {
        ...
        {
            var alert = new ChairDetectedAlert()
            {

...
If you previosly had already installed kubectl and it is pointing to some other Kubernetes environment, make sure the default kubectl context is pointing to the right cluster. 

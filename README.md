...
| | |
|--------|--------|
| **Azure IoT Operations (Aio):** <img width="120" alt="image" src="https://github.com/Azure/mec-app-solution-accelerator/assets/1712635/3fced6ab-6c54-4120-95f1-11f1ac74f5dc">| Components used: Azure IoT MQ (aka. E4K) as MQTT broker and Azure IoT AKRI for dynamic provisioning of video cameras stream ingestion. Aio is optional, for a OSS deployment you can use Mosquitto and AKRI-OSS. For production, Aio is preferred. |
